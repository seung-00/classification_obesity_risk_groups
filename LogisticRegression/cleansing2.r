...
df17_18 <- read.csv("국민건강영양조사(2017~2018).csv", header = T)
dm_df <- df17_18
...
dm_df2 <- dm_df %>% select(-age_month, - wt_pft, - wt_vt, - wt_nn, - wt_pfnt, - wt_pfvt, - wt_pfvtnt, - wt_vtnt, - wt_nnnt,
...
src_data <- dm_df2 %>% select(-X,-year, -mod_d, -DE1_35, -DC11_tp, -DC12_tp, -M_2_et, -BH9_14_4_02, -N_DT_DS, -N_DT_DS, -AC3_3e_01, -AC8_1e_01, -AC3_3e_02, -LQ4_24, -BH9_14_4_01, -N_DAY, -BM14_2, -BO3_11, -EC_wht_6, -BS5_31, -BS12_35)
...
write.csv(cleaned_data, file="cleaned_data3.csv", row.names=FALSE)